...
def generate_launch_description():
    ...
    pkg_box_bot_gazebo = get_package_share_directory("amr-rmf")
    ...
    if "GAZEBO_PLUGIN_PATH" in os.environ:
        os.environ["GAZEBO_PLUGIN_PATH"] = (
            ...
            + "/lib"
            + ":"
            + gazebo_plugins_name_path_install_dir
            + "/lib"
        )
    else:
        os.environ["GAZEBO_PLUGIN_PATH"] = (
            install_dir + "/lib" + ":" + gazebo_plugins_name_path_install_dir + "/lib"
        )
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "world",
                default_value=[
                    os.path.join(pkg_box_bot_gazebo, "worlds", "tc_coffeeshop.world"),
                    "",
                ],
