...
class DispenserContext(WorkcellContext):
    _dispenser_id: str
...
class LdmDoorContext(WorkcellContext):
    _floor_id: str
    _door_id: str
    _door_type: str
...
class LdmClient:
    ...
    _context_dict: dict[str, WorkcellContext]
    ...
    def get_contexts(self) -> dict[str, WorkcellContext]:
